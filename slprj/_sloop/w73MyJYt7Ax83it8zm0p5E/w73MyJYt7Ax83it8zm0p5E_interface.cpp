 ...
 * w73MyJYt7Ax83it8zm0p5E
 */

#include "xil_interface.h"
#include "xil_data_stream.h"

#include "w73MyJYt7Ax83it8zm0p5E_interface.h"
...
/* Function Init/Term */
void customcode_w73MyJYt7Ax83it8zm0p5E_initializer(void)
{
}

void customcode_w73MyJYt7Ax83it8zm0p5E_terminator(void)
{
}

/* Function isDebug */
boolean_T customcode_w73MyJYt7Ax83it8zm0p5E_isdebug(void)
{
   return true;
}
...
void pivot_on_w73MyJYt7Ax83it8zm0p5E(Tableau *tab, int32_T row, int32_T col)
{
    pivot_on(tab, row, col);
}

int32_T find_pivot_column_w73MyJYt7Ax83it8zm0p5E(Tableau *tab)
{
    return find_pivot_column(tab);
}

int32_T find_pivot_row_w73MyJYt7Ax83it8zm0p5E(Tableau *tab, int32_T pivot_col)
{
    return find_pivot_row(tab, pivot_col);
}

void add_slack_variables_w73MyJYt7Ax83it8zm0p5E(Tableau *tab)
{
    add_slack_variables(tab);
}

void check_b_positive_w73MyJYt7Ax83it8zm0p5E(Tableau *tab)
{
    check_b_positive(tab);
}

int32_T find_basis_variable_w73MyJYt7Ax83it8zm0p5E(Tableau *tab, int32_T col)
{
    return find_basis_variable(tab, col);
}

void print_optimal_vector_w73MyJYt7Ax83it8zm0p5E(Tableau *tab, real_T *T1, real_T *T2, real_T *T3, real_T *T4)
{
    print_optimal_vector(tab, T1, T2, T3, T4);
}

int32_T simplex_w73MyJYt7Ax83it8zm0p5E(Tableau *tab, real_T *T1, real_T *T2, real_T *T3, real_T *T4)
{
    return simplex(tab, T1, T2, T3, T4);
}

int32_T bigM_func_w73MyJYt7Ax83it8zm0p5E(real_T T2F_1, real_T T2F_2, real_T T2F_3, real_T T2F_4, real_T b, real_T A_1, real_T A_2, real_T A_3, real_T A_4, real_T beq, real_T Aeq_1, real_T Aeq_2, real_T Aeq_3, real_T Aeq_4, real_T lb_1, real_T lb_2, real_T lb_3, real_T lb_4, real_T ub_1, real_T ub_2, real_T ub_3, real_T ub_4, real_T *T1, real_T *T2, real_T *T3, real_T *T4, real_T yaw_err_limit)
{
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
    ...
    case 0:
    {
        ...
        customcode_w73MyJYt7Ax83it8zm0p5E_initializer();
    ...
    case 1:
    {
        ...
        customcode_w73MyJYt7Ax83it8zm0p5E_terminator();
    ...
    case 2:
    {
        ...
        isAllowToDebug = customcode_w73MyJYt7Ax83it8zm0p5E_isdebug();
    ...
    case 3:
    {
        ...
        pivot_on_w73MyJYt7Ax83it8zm0p5E(tab, row, col);
    ...
    case 4:
    {
        ...
        out = find_pivot_column_w73MyJYt7Ax83it8zm0p5E(tab);
    ...
    case 5:
    {
        ...
        out = find_pivot_row_w73MyJYt7Ax83it8zm0p5E(tab, pivot_col);
    ...
    case 6:
    {
        ...
        add_slack_variables_w73MyJYt7Ax83it8zm0p5E(tab);
    ...
    case 7:
    {
        ...
        check_b_positive_w73MyJYt7Ax83it8zm0p5E(tab);
    ...
    case 8:
    {
        ...
        out = find_basis_variable_w73MyJYt7Ax83it8zm0p5E(tab, col);
    ...
    case 9:
    {
        ...
        print_optimal_vector_w73MyJYt7Ax83it8zm0p5E(tab, T1, T2, T3, T4);
    ...
    case 10:
    {
        ...
        out = simplex_w73MyJYt7Ax83it8zm0p5E(tab, T1, T2, T3, T4);
    ...
    case 11:
    {
        ...
        out = bigM_func_w73MyJYt7Ax83it8zm0p5E(T2F_1, T2F_2, T2F_3, T2F_4, b, A_1, A_2, A_3, A_4, beq, Aeq_1, Aeq_2, Aeq_3, Aeq_4, lb_1, lb_2, lb_3, lb_4, ub_1, ub_2, ub_3, ub_4, T1, T2, T3, T4, yaw_err_limit);
