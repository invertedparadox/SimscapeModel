#ifndef __SFS_sfun_h__
#define __SFS_sfun_h__
...
extern mxArray* load_SFS_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_SFS_optimization_info(void);
