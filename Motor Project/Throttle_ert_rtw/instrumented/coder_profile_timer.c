...
/* Code instrumentation offset(s) for model Throttle Map */
#define profileStart_Throttle_Map_offset 0
#define profileEnd_Throttle_Map_offset 0
...
/* Code instrumentation method(s) for model Throttle Map */
void profileStart_Throttle_Map(uint32_T sectionId)
{
  profileStart(profileStart_Throttle_Map_offset + sectionId);
}

void profileEnd_Throttle_Map(uint32_T sectionId)
{
  profileEnd(profileEnd_Throttle_Map_offset + sectionId);
}
