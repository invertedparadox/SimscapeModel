...
void Throttle_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  /* Lookup_n-D: '<S1>/k_max' */
  bpIndices[0U] = plook_evenc(rtU->V[0], rtP.voltage_sweep_min[0],
    rtP.voltage_sweep_min[1] - rtP.voltage_sweep_min[0], 25U, &rtb_k_min_idx_1);
  fractions[0U] = rtb_k_min_idx_1;
  bpIndices[1U] = plook_evenc(rtU->w[0], rtP.rpm_sweep_min[0],
    rtP.rpm_sweep_min[1] - rtP.rpm_sweep_min[0], 106U, &rtb_k_min_idx_1);
  fractions[1U] = rtb_k_min_idx_1;
  rtb_k_max_idx_0 = intrp2d_l(bpIndices, fractions, rtP.k_grid_max, 26U);
  bpIndices[0U] = plook_evenc(rtU->V[1], rtP.voltage_sweep_min[0],
    rtP.voltage_sweep_min[1] - rtP.voltage_sweep_min[0], 25U, &rtb_k_min_idx_1);
  fractions[0U] = rtb_k_min_idx_1;
  bpIndices[1U] = plook_evenc(rtU->w[1], rtP.rpm_sweep_min[0],
    rtP.rpm_sweep_min[1] - rtP.rpm_sweep_min[0], 106U, &rtb_k_min_idx_1);
  fractions[1U] = rtb_k_min_idx_1;

  /* Lookup_n-D: '<S1>/k_min' */
  bpIndices_0[0U] = plook_evenc(rtU->V[0], rtP.voltage_sweep_min[0],
    rtP.voltage_sweep_min[1] - rtP.voltage_sweep_min[0], 25U, &rtb_k_min_idx_1);
  fractions_0[0U] = rtb_k_min_idx_1;
  bpIndices_0[1U] = plook_evenc(rtU->w[0], rtP.rpm_sweep_min[0],
    rtP.rpm_sweep_min[1] - rtP.rpm_sweep_min[0], 106U, &rtb_k_min_idx_1);
  fractions_0[1U] = rtb_k_min_idx_1;
  rtb_k_min_idx_0 = intrp2d_l(bpIndices_0, fractions_0, rtP.k_grid_min, 26U);
  bpIndices_0[0U] = plook_evenc(rtU->V[1], rtP.voltage_sweep_min[0],
    rtP.voltage_sweep_min[1] - rtP.voltage_sweep_min[0], 25U, &rtb_k_min_idx_1);
  fractions_0[0U] = rtb_k_min_idx_1;
  bpIndices_0[1U] = plook_evenc(rtU->w[1], rtP.rpm_sweep_min[0],
    rtP.rpm_sweep_min[1] - rtP.rpm_sweep_min[0], 106U, &rtb_k_min_idx_1);
  fractions_0[1U] = rtb_k_min_idx_1;
  rtb_k_min_idx_1 = intrp2d_l(bpIndices_0, fractions_0, rtP.k_grid_min, 26U);
  ...
  rtY->k[1] = (intrp2d_l(bpIndices, fractions, rtP.k_grid_max, 26U) -
               rtb_k_min_idx_1) * rtU->r[1] + rtb_k_min_idx_1;
