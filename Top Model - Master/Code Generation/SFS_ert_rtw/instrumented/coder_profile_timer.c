...
/* Code instrumentation offset(s) for model SFS */
#define profileStart_SFS_offset        0
#define profileEnd_SFS_offset          0
...
{
  profileStart(profileStart_SFS_offset + sectionId);
}

void profileEnd_SFS(uint32_T sectionId)
{
  profileEnd(profileEnd_SFS_offset + sectionId);
}
