...
/* Code instrumentation offset(s) for model Electronics */
#define profileStart_Electronics_offset 0
#define profileEnd_Electronics_offset  0
...
/* Code instrumentation method(s) for model Electronics */
void profileStart_Electronics(uint32_T sectionId)
{
  profileStart(profileStart_Electronics_offset + sectionId);
}

void profileEnd_Electronics(uint32_T sectionId)
{
  profileEnd(profileEnd_Electronics_offset + sectionId);
}
