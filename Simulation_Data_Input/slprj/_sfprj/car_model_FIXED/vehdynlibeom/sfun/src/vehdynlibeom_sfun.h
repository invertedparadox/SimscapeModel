#ifndef __vehdynlibeom_sfun_h__
#define __vehdynlibeom_sfun_h__
...
extern mxArray* load_vehdynlibeom_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_vehdynlibeom_optimization_info(void);
