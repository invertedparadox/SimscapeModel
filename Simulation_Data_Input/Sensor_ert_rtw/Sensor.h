 ...
 * C/C++ source code generated on : Thu Apr 20 13:56:54 2023
 *
 ...
 *
 * hilite_system('car_model_temp/Control Systems/Sensor')    - opens subsystem car_model_temp/Control Systems/Sensor
 * hilite_system('car_model_temp/Control Systems/Sensor/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'car_model_temp/Control Systems'
 * '<S1>'   : 'car_model_temp/Control Systems/Sensor'
 * '<S2>'   : 'car_model_temp/Control Systems/Sensor/SNED to VNED'
 */
