...
## Generated on : Thu Apr 20 13:52:27 2023
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Subsystem.elf
...
SRCS = $(START_DIR)/Subsystem_ert_rtw/Subsystem.c $(START_DIR)/Subsystem_ert_rtw/Subsystem_data.c
...
OBJS = Subsystem.o Subsystem_data.o
...
%.o : $(START_DIR)/Subsystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Subsystem_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Subsystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Subsystem_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Subsystem_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Subsystem.o : $(START_DIR)/Subsystem_ert_rtw/Subsystem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Subsystem_data.o : $(START_DIR)/Subsystem_ert_rtw/Subsystem_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Subsystem_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
