...
void MC_PL0_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  for (i = 0; i < 4; i++) {
     ...
     *  Switch: '<S9>/Switch'
     */
    profileStart_MC_PL(1U); /* original_line:488 */rtDW->Switch[i] = fabs(rtU->Tx[i]);profileEnd_MC_PL(1U); /* original_line:488 */
  }
   ...
   *  Switch: '<S9>/Switch'
   */
  profileStart_MC_PL(2U); /* original_line:495 */rtDW->bpIndices[0U] = plook_evenca(rtDW->Switch[0], 0.0, 1.6666666666666665,
    15U, &rtDW->Sum1);profileEnd_MC_PL(2U); /* original_line:496 */
  rtDW->fractions[0U] = rtDW->Sum1;
  profileStart_MC_PL(3U); /* original_line:498 */rtDW->bpIndices[1U] = plook_evenca(rtDW->Sum[0], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(3U); /* original_line:499 */
  rtDW->fractions[1U] = rtDW->Sum1;
  profileStart_MC_PL(4U); /* original_line:501 */rtDW->Switch[0] = intrp2d_la(rtDW->bpIndices, rtDW->fractions,
    rtConstP.uDLookupTable_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(4U); /* original_line:502 */
  profileStart_MC_PL(5U); /* original_line:503 */rtDW->bpIndices[0U] = plook_evenca(rtDW->Switch[1], 0.0, 1.6666666666666665,
    15U, &rtDW->Sum1);profileEnd_MC_PL(5U); /* original_line:504 */
  rtDW->fractions[0U] = rtDW->Sum1;
  profileStart_MC_PL(6U); /* original_line:506 */rtDW->bpIndices[1U] = plook_evenca(rtDW->Sum[1], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(6U); /* original_line:507 */
  rtDW->fractions[1U] = rtDW->Sum1;
  profileStart_MC_PL(7U); /* original_line:509 */rtDW->Switch[1] = intrp2d_la(rtDW->bpIndices, rtDW->fractions,
    rtConstP.uDLookupTable_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(7U); /* original_line:510 */
  profileStart_MC_PL(8U); /* original_line:511 */rtDW->bpIndices[0U] = plook_evenca(rtDW->Switch[2], 0.0, 1.6666666666666665,
    15U, &rtDW->Sum1);profileEnd_MC_PL(8U); /* original_line:512 */
  rtDW->fractions[0U] = rtDW->Sum1;
  profileStart_MC_PL(9U); /* original_line:514 */rtDW->bpIndices[1U] = plook_evenca(rtDW->Sum[2], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(9U); /* original_line:515 */
  rtDW->fractions[1U] = rtDW->Sum1;
  profileStart_MC_PL(10U); /* original_line:517 */rtDW->Switch[2] = intrp2d_la(rtDW->bpIndices, rtDW->fractions,
    rtConstP.uDLookupTable_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(10U); /* original_line:518 */
  profileStart_MC_PL(11U); /* original_line:519 */rtDW->bpIndices[0U] = plook_evenca(rtDW->Switch[3], 0.0, 1.6666666666666665,
    15U, &rtDW->Sum1);profileEnd_MC_PL(11U); /* original_line:520 */
  rtDW->fractions[0U] = rtDW->Sum1;
  profileStart_MC_PL(12U); /* original_line:522 */rtDW->bpIndices[1U] = plook_evenca(rtDW->Sum[3], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(12U); /* original_line:523 */
  rtDW->fractions[1U] = rtDW->Sum1;
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(13U); /* original_line:618 */rtDW->Sum1 = look1_binlc(rtDW->Sum[0], rtConstP.uDLookupTable_bp01Data,
    rtConstP.uDLookupTable_tableData_g, 67U);profileEnd_MC_PL(13U); /* original_line:619 */
   ...
   *  Product: '<S3>/Divide'
   */
  profileStart_MC_PL(14U); /* original_line:683 */rtb_Divide_l_idx_0 = fabs(rtDW->rtb_RateLimiter_m_c);profileEnd_MC_PL(14U); /* original_line:683 */
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(15U); /* original_line:777 */rtDW->Sum1 = look1_binlc(rtDW->Sum[1], rtConstP.uDLookupTable_bp01Data,
    rtConstP.uDLookupTable_tableData_g, 67U);profileEnd_MC_PL(15U); /* original_line:778 */
   ...
   *  Product: '<S3>/Divide'
   */
  profileStart_MC_PL(16U); /* original_line:842 */rtb_Divide_l_idx_1 = fabs(rtDW->rtb_RateLimiter_m_c);profileEnd_MC_PL(16U); /* original_line:842 */
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(17U); /* original_line:936 */rtDW->Sum1 = look1_binlc(rtDW->Sum[2], rtConstP.uDLookupTable_bp01Data,
    rtConstP.uDLookupTable_tableData_g, 67U);profileEnd_MC_PL(17U); /* original_line:937 */
   ...
   *  Product: '<S3>/Divide'
   */
  profileStart_MC_PL(18U); /* original_line:1001 */rtb_Divide_l_idx_2 = fabs(rtDW->rtb_RateLimiter_m_c);profileEnd_MC_PL(18U); /* original_line:1001 */
   ...
   */
  profileStart_MC_PL(19U); /* original_line:1019 */rtDW->Sum1 *= intrp2d_la(rtDW->bpIndices, rtDW->fractions,
    rtConstP.uDLookupTable_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(19U); /* original_line:1020 */
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(20U); /* original_line:1096 */rtDW->Sum1 = look1_binlc(rtDW->Sum[3], rtConstP.uDLookupTable_bp01Data,
    rtConstP.uDLookupTable_tableData_g, 67U);profileEnd_MC_PL(20U); /* original_line:1097 */
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(21U); /* original_line:1146 */rtDW->bpIndices_p[0U] = plook_evenca(rtb_Divide_l_idx_0, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(21U); /* original_line:1147 */
  rtDW->fractions_m[0U] = rtDW->Sum1;
  profileStart_MC_PL(22U); /* original_line:1149 */rtDW->bpIndices_p[1U] = plook_evenca(rtDW->Sum[0], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(22U); /* original_line:1150 */
  rtDW->fractions_m[1U] = rtDW->Sum1;
  profileStart_MC_PL(23U); /* original_line:1152 */rtb_Divide_l_idx_0 = intrp2d_la(rtDW->bpIndices_p, rtDW->fractions_m,
    rtConstP.uDLookupTable1_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(23U); /* original_line:1153 */
  profileStart_MC_PL(24U); /* original_line:1154 */rtDW->bpIndices_p[0U] = plook_evenca(rtb_Divide_l_idx_1, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(24U); /* original_line:1155 */
  rtDW->fractions_m[0U] = rtDW->Sum1;
  profileStart_MC_PL(25U); /* original_line:1157 */rtDW->bpIndices_p[1U] = plook_evenca(rtDW->Sum[1], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(25U); /* original_line:1158 */
  rtDW->fractions_m[1U] = rtDW->Sum1;
  profileStart_MC_PL(26U); /* original_line:1160 */rtb_Divide_l_idx_1 = intrp2d_la(rtDW->bpIndices_p, rtDW->fractions_m,
    rtConstP.uDLookupTable1_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(26U); /* original_line:1161 */
  profileStart_MC_PL(27U); /* original_line:1162 */rtDW->bpIndices_p[0U] = plook_evenca(rtb_Divide_l_idx_2, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(27U); /* original_line:1163 */
  rtDW->fractions_m[0U] = rtDW->Sum1;
  profileStart_MC_PL(28U); /* original_line:1165 */rtDW->bpIndices_p[1U] = plook_evenca(rtDW->Sum[2], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(28U); /* original_line:1166 */
  rtDW->fractions_m[1U] = rtDW->Sum1;
  profileStart_MC_PL(29U); /* original_line:1168 */rtb_Divide_l_idx_2 = intrp2d_la(rtDW->bpIndices_p, rtDW->fractions_m,
    rtConstP.uDLookupTable1_tableData, 16U, rtConstP.pooled6);profileEnd_MC_PL(29U); /* original_line:1169 */
  profileStart_MC_PL(30U); /* original_line:1170 */rtDW->bpIndices_p[0U] = plook_evenca(fabs(rtDW->rtb_RateLimiter_m_c), 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(30U); /* original_line:1171 */
  rtDW->fractions_m[0U] = rtDW->Sum1;
  profileStart_MC_PL(31U); /* original_line:1173 */rtDW->bpIndices_p[1U] = plook_evenca(rtDW->Sum[3], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(31U); /* original_line:1174 */
  rtDW->fractions_m[1U] = rtDW->Sum1;
  ...
  if (rtDW->Sum[3] > rtP.feebackThreshhold) {
     ...
     *  Product: '<S3>/Divide'
     */
    profileStart_MC_PL(32U); /* original_line:1398 */rtb_Switch_c_idx_0 = intrp2d_la(rtDW->bpIndices_p, rtDW->fractions_m,
      rtConstP.uDLookupTable1_tableData, 16U, rtConstP.pooled6) / rtU->Motor_V[3];profileEnd_MC_PL(32U); /* original_line:1399 */
   ...
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(33U); /* original_line:1440 */rtDW->bpIndices_c[0U] = plook_evenc(rtDW->rtb_RateLimiter_m_idx_0, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(33U); /* original_line:1441 */
  rtDW->fractions_c[0U] = rtDW->Sum1;
  profileStart_MC_PL(34U); /* original_line:1443 */rtDW->bpIndices_c[1U] = plook_evenc(rtDW->Sum[0], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(34U); /* original_line:1444 */
  rtDW->fractions_c[1U] = rtDW->Sum1;

  /* Update for UnitDelay: '<S5>/Unit Delay' incorporates:
   *  Lookup_n-D: '<S5>/2-D Lookup Table'
   */
  profileStart_MC_PL(35U); /* original_line:1450 */rtDW->UnitDelay_DSTATE[0] = intrp2d_l(rtDW->bpIndices_c, rtDW->fractions_c,
    rtConstP.uDLookupTable_tableData_b, 16U);profileEnd_MC_PL(35U); /* original_line:1451 */

  /* Lookup_n-D: '<S5>/2-D Lookup Table' incorporates:
   *  RateLimiter: '<S5>/Rate Limiter'
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(36U); /* original_line:1457 */rtDW->bpIndices_c[0U] = plook_evenc(rtDW->rtb_RateLimiter_m_idx_1, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(36U); /* original_line:1458 */
  rtDW->fractions_c[0U] = rtDW->Sum1;
  profileStart_MC_PL(37U); /* original_line:1460 */rtDW->bpIndices_c[1U] = plook_evenc(rtDW->Sum[1], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(37U); /* original_line:1461 */
  rtDW->fractions_c[1U] = rtDW->Sum1;

  /* Update for UnitDelay: '<S5>/Unit Delay' incorporates:
   *  Lookup_n-D: '<S5>/2-D Lookup Table'
   */
  profileStart_MC_PL(38U); /* original_line:1467 */rtDW->UnitDelay_DSTATE[1] = intrp2d_l(rtDW->bpIndices_c, rtDW->fractions_c,
    rtConstP.uDLookupTable_tableData_b, 16U);profileEnd_MC_PL(38U); /* original_line:1468 */

  /* Lookup_n-D: '<S5>/2-D Lookup Table' incorporates:
   *  RateLimiter: '<S5>/Rate Limiter'
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(39U); /* original_line:1474 */rtDW->bpIndices_c[0U] = plook_evenc(rtb_RateLimiter_m_idx_2, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(39U); /* original_line:1475 */
  rtDW->fractions_c[0U] = rtDW->Sum1;
  profileStart_MC_PL(40U); /* original_line:1477 */rtDW->bpIndices_c[1U] = plook_evenc(rtDW->Sum[2], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(40U); /* original_line:1478 */
  rtDW->fractions_c[1U] = rtDW->Sum1;

  /* Update for UnitDelay: '<S5>/Unit Delay' incorporates:
   *  Lookup_n-D: '<S5>/2-D Lookup Table'
   */
  profileStart_MC_PL(41U); /* original_line:1484 */rtDW->UnitDelay_DSTATE[2] = intrp2d_l(rtDW->bpIndices_c, rtDW->fractions_c,
    rtConstP.uDLookupTable_tableData_b, 16U);profileEnd_MC_PL(41U); /* original_line:1485 */

  /* Lookup_n-D: '<S5>/2-D Lookup Table' incorporates:
   *  Sum: '<S1>/Sum'
   */
  profileStart_MC_PL(42U); /* original_line:1490 */rtDW->bpIndices_c[0U] = plook_evenc(rtDW->rtb_RateLimiter_m_c, 0.0,
    1.6666666666666665, 15U, &rtDW->Sum1);profileEnd_MC_PL(42U); /* original_line:1491 */
  rtDW->fractions_c[0U] = rtDW->Sum1;
  profileStart_MC_PL(43U); /* original_line:1493 */rtDW->bpIndices_c[1U] = plook_evenc(rtDW->Sum[3], 0.0, 10.4719755, 106U,
    &rtDW->Sum1);profileEnd_MC_PL(43U); /* original_line:1494 */
  rtDW->fractions_c[1U] = rtDW->Sum1;
   ...
   *  Lookup_n-D: '<S5>/2-D Lookup Table'
   */
  profileStart_MC_PL(44U); /* original_line:1588 */rtDW->UnitDelay_DSTATE[3] = intrp2d_l(rtDW->bpIndices_c, rtDW->fractions_c,
    rtConstP.uDLookupTable_tableData_b, 16U);profileEnd_MC_PL(44U); /* original_line:1589 */
}
